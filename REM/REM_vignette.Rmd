...
hist(dataREM$angle)
FOV <- 52 # field of view of the cameras (degrees)
w_ang <- 0.41
...
```
Effective detection radius (**Fig. 5**) is 0.41 rad (SE=0.04)
...
operat <- read.table("Operativity.txt", sep = ";", dec=".", header=TRUE, as.is=TRUE)
